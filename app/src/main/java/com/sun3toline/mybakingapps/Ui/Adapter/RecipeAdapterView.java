...
import com.sun3toline.mybakingapps.Ui.ResepDetailActivity;
...
public class RecipeAdapterView extends RecyclerView.Adapter<RecipeAdapterView.RecipeViewHolder> {
    ...
    private List<Resep> recipes;

    public RecipeAdapterView(List<Resep> recipes){
    ...
    public void onBindViewHolder(RecipeViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(ResepDetailActivity.RECIPE, new GsonBuilder().create().toJson(recipe));
